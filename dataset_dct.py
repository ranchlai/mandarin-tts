...
class Dataset(Dataset):
    def __init__(self, filename="train.txt",cn_filename = "train_cn.txt",cn_vocab_file = './cn_vocab.txt', sort=True):
        ...
        self.cn_vocab = ['pad'] + self.cn_vocab + ['sil','sp1']
        _, self.cn_text = process_meta(
            os.path.join(hparams.preprocessed_path, cn_filename))
    ...
    def __getitem__(self, idx):
        ...
        mel_path = os.path.join(
            hparams.preprocessed_path, "dct", "{}-dct-{}.npy".format(hparams.dataset, basename))
    ...
    def reprocess(self, batch, cut_list):
        ...
        Ds  = [d-18.877746355061273 for d in Ds]
